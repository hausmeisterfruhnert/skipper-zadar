...
exports["pro-person"] = (ctx) => {
  ...
  const x = pick(l,{
    de:{ eyebrow:"Einzeln mitfahren · Preis pro Person", h1:"Touren pro Person ab Zadar",
      ...
      incH:"✅ Das ist dabei",
      inc:["Deutschsprachiger Skipper & lokaler Guide","Kraftstoff & alle Gebühren","Sicherheitsausrüstung & Rettungswesten","Handtücher an Bord","Trinkwasser & 1 Willkommensgetränk","Echte Bord-Toilette & schattige Kabine"],
      noH:"Optional / nicht dabei", no:["Mittagessen (Stopp im Inseldorf möglich)","Schnorchel-Ausrüstung (bitte selbst mitbringen)","Hotel-Transfer"],
      ...
      bringH:"Was mitbringen", bring:["Badesachen / Badekleidung","Eigene Schnorchel-Ausrüstung","Sonnencreme & Sonnenhut","Kamera für die schönsten Momente"],
    ...
    hr:{ eyebrow:"Pridružite se pojedinačno · Cijena po osobi", h1:"Ture po osobi iz Zadra",
      ...
      incH:"✅ Uključeno", inc:["Skiper koji govori njemački i lokalni vodič","Gorivo i sve pristojbe","Sigurnosna oprema i prsluci","Ručnici na brodu","Pitka voda i welcome piće","Pravi brodski WC i sjenovita kabina"],
      noH:"Opcionalno / nije uključeno", no:["Ručak (moguć stop u otočkom mjestu)","Oprema za ronjenje (molimo ponesite svoju)","Transfer iz hotela"],
      ...
      bringH:"Što ponijeti", bring:["Kupaći kostim","Vlastita oprema za ronjenje","Krema za sunčanje i šešir","Fotoaparat za najljepše trenutke"],
    ...
    en:{ eyebrow:"Join individually · Price per person", h1:"Per-Person Boat Tours from Zadar",
      ...
      incH:"✅ What's included", inc:["German-speaking skipper & local guide","Fuel & all fees","Safety equipment & life jackets","Towels on board","Drinking water & 1 welcome drink","Real on-board WC & shaded cabin"],
      noH:"Optional / not included", no:["Lunch (island-village stop possible)","Snorkelling gear (please bring your own)","Hotel transfer"],
      ...
      bringH:"What to bring", bring:["Swimwear","Your own snorkelling gear","Sunscreen & sun hat","Camera for the best moments"],
